...
<body>
    ...
    <footer>
		<div class="container">
			...
			<p><strong><?= getLink("Lybra") ?> </strong> est un site internet pour le lyceé de Boubara. Immaginé par <strong>Mr. Nana Nana</strong> professeur d'informatique et l'élève <strong><?= getLink('Mouhamed Amine') ?></strong> et conçu par <strong><?= getLink('Mouhamed Amine') ?></strong></p>
		</div>
